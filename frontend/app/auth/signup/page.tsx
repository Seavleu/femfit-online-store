...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, redirect to Google sign-in since we're using Supabase Auth
      // In a real app, you'd implement email/password signup with Supabase
      await signIn('google');
      router.push('/profile');
    } catch (error) {
      ...
      <div className="max-w-md mx-auto px-6 py-12">
        ...
        >
          ...
          <button
            ...
            className="w-full border border-gray-200 py-3 px-6 font-medium hover:border-black transition-colors flex items-center justify-center space-x-2"
          >
